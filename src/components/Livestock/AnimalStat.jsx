          ...
          <div className="thm-bg thm-shadow-m p-3 rounded-2 text-center">
            <div className="d-flex justify-content-evenly">
              <div>
                ...
                <p className="text-center fs-1">Bovins</p>
                <p className="text-center fs-1">
                  {count("bovins", "male") + count("bovins", "female")}
                </p>
              </div>
              <div>
                <div className="d-flex justify-content-center">
                  <div>
                    ...
                    <p className="fs-5 mb-1">Taureaux</p>
                    <p className="fs-3 fw-bold">{count("bovins", "male")}</p>
                  </div>
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="fs-5 mb-1">Vaches</p>
                    <p className="fs-3 fw-bold">{count("bovins", "female")}</p>
                  </div>
                </div>
                <hr />
                <p className="fs-3 text-center">
                  Total: {count("bovins", "male") + count("bovins", "female")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="thm-bg thm-shadow-m p-3 rounded-2 text-center">
            <div className="d-flex justify-content-evenly">
              <div>
                ...
                <p className="fs-1">Ovins</p>
                <p className="fs-1">
                  {count("ovins", "male") + count("ovins", "female")}
                </p>
              </div>
              <div>
                <div className="d-flex justify-content-center">
                  <div>
                    ...
                    <p className="fs-5 mb-1">Béliers</p>
                    <p className="fs-3 fw-bold">{count("ovins", "male")}</p>
                  </div>
                  <div>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="fs-5 mb-1">Brebis</p>
                    <p className="fs-3 fw-bold">{count("ovins", "female")}</p>
                  </div>
                </div>
                <hr />
                <p className="fs-3 text-center">
                  Total: {count("ovins", "male") + count("ovins", "female")}
                </p>
              </div>
            </div>
          </div>
