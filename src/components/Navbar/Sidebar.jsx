...
const Sidebar = () => {
  ...
  return (
    <div>
      <div className="d-flex flex-column justify-content-between thm-bg py-4">
        <div className="mx-auto thm-bg-light thm-shadow-m p-2 rounded-2">
          <Link href={"/dashboard"}>
            <svg
        ...
        <div className="mx-auto mt-3 thm-bg-light thm-shadow-m p-2 rounded-2">
          <Link href={"/map"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
        ...
        <div className="mx-auto mt-3 thm-bg-light thm-shadow-m rounded-2">
          <div className="dropdown">
            ...
            <ul className="dropdown-menu thm-bg-light">
              <li>
                <button className="dropdown-item" onClick={toggleLight}>
        ...
        <div className="mx-auto mt-3 thm-bg-light thm-shadow-m rounded-2">
          <div className="dropdown">
            ...
            <ul className="dropdown-menu thm-bg-light">
              <li>
                <a className="dropdown-item" href="#">
                  <i className="bi bi-person-fill-gear"></i> Paramètre du compte
                </a>
              </li>
              <li>
