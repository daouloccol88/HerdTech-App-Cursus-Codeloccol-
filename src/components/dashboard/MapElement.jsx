...
const MapElement = () => {
  return (
    <div
      ...
      style={{ height: "300px" }}
    >
      <p className="fs-5">Liste des marqueurs configuré pour la carte</p>
      <div className="container-fluid">
        <div className="row">
          <div className="col-4 thm-bg-light ">
            <span className="thm-shadow-m rounded-circle text-center p-3">
              <svg
